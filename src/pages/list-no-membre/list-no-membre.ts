...
/**
 * Generated class for the ListNoMembrePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-list-no-membre',
  templateUrl: 'list-no-membre.html',
})
export class ListNoMembrePage {
  employees: Array<any>;
  loadingList = false;
  loading: any;
  ...
  getEmployee(): void
  {
    this.employeeProvider.getNoMembre()
    .subscribe( res => {
      if (res['success'] === true) {
