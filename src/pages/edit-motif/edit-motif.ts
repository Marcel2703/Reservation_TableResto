...
/**
 * Generated class for the EditMotifPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-edit-motif',
  templateUrl: 'edit-motif.html',
})
export class EditMotifPage {
  form: FormGroup;
  motif = new Motif();
  errors = [];
  loading: any;
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad EditMotifPage');
